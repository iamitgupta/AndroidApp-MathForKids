...
public class divtest extends AppCompatActivity {
    int min=1, max=10,a=0,b=0,c=0,x=0,y=0,p=0,q=0,r=0,v=0,t=0;
    TextView tv_a,tv_b;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_divtest);
    ...
    public void rand(){
        ...
        if(a % b!=0) {
            ...
            if(c==1){
                ...
                bt_3.setText(Integer.toString(x));
            }else if(c==2){
                q=a/b;
